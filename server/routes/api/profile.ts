...
//       check("waistdiameter", "Waistdiameter is required").not().isEmpty(),
//       check("shoulderdiameter", "Shoulderdiameter is required").not().isEmpty(),
//       check("chestdiameter", "Chestdiameter is required").not().isEmpty(),
//       check("legsdiameter", "Legsdiameter is required").not().isEmpty(),
//     ],
//   ],
//   async (req, res) => {
